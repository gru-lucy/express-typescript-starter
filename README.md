...
![GitHub package.json version](https://img.shields.io/github/package-json/v/gru-lucy/express-typescript-starter?style=flat-square)
![GitHub CI Workflow Status](https://img.shields.io/github/actions/workflow/status/gru-lucy/express-typescript-starter/ci.yml?branch=main&style=flat-square&logo=github&label=CI)
![GitHub CD Workflow Status](https://img.shields.io/github/actions/workflow/status/gru-lucy/express-typescript-starter/cd.yml?branch=main&style=flat-square&logo=github&label=CD)
![GitHub LICENSE](https://img.shields.io/github/license/gru-lucy/express-typescript-starter?style=flat-square)
...
[![Stargazers repo roster for @gru-lucy/express-typescript-starter](https://reporoster.com/stars/gru-lucy/express-typescript-starter)](https://github.com/gru-lucy/express-typescript-starter/stargazers)

## 🚩 License

MIT @ [gru-lucy](https://bpaz.dev). Please see [License](LICENSE) for more information.
